...
await writeFile('dist/build-info.json',JSON.stringify({version:'6.0.0',commit:process.env.VERCEL_GIT_COMMIT_SHA||process.env.GITHUB_SHA||'local',built_at:new Date().toISOString(),mode:'browser_lexical',no_model_weights:true},null,2));
